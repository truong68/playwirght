        ...
        try:
            for idx, row in df.iterrows():
                ...
                try:
                    ...
                    # ĐOẠN DUY NHẤT GÕ NỘI DUNG – ĐẸP + KHÔNG DOUBLE
                    if content and content != "nan":
                        ...
                        print(f"[{phone}] ĐÃ GÕ NỘI DUNG + XUỐNG DÒNG ĐẸP ({len(lines)} đoạn)")
                    else:
                        print(f"[{phone}] Không có nội dung để gõ (cột content trống)")

                except Exception as e:
                    print(f"[{phone}] Lỗi khi focus/gõ nội dung: {e}")

                # BẤM ICON KHUNG TRÒN XANH
